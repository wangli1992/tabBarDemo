 ...
 * as custom events that can be used in an module.
 *
...
(function(window, document, ionic) {
   ...
   * various other information such as what kind of platform the module is currently installed on.
   *
   * @usage
   * ```js
   ...
   *
   *   ionic.Platform.exitApp(); // stops the module
   * });
   * ```
   */
  var self = ionic.Platform = {
     ...
     * When the module is within a WebView (Cordova), it'll fire
     * the callback once the device is ready. If the module is within
     ...
     * @description
     * Sets whether the module is fullscreen or not (in Cordova).
     * @param {boolean=} showFullScreen Whether or not to set the module to fullscreen. Defaults to true. Requires `ionic plugin add cordova-plugin-statusbar`
 ...
 *
 * ### Android Notes
 * - If your module is running in fullscreen, i.e. you have
 *   `<preference name="Fullscreen" value="true" />` in your `config.xml` file
 *   you will need to set `ionic.Platform.isFullScreen = true` manually.
 *
 * - You can configure the behavior of the web view when the keyboard shows by setting
 *   [android:windowSoftInputMode](http://developer.android.com/reference/android/R.attr.html#windowSoftInputMode)
 *   to either `adjustPan`, `adjustResize` or `adjustNothing` in your module's
 ...
 *
 * ### iOS Notes
 * - If the content of your module (including the header) is being pushed up and
...
function keyboardFocusIn(e) {
  ...
  if (!scrollView.classList.contains("overflow-scroll")) {
    ...
    // could touchmove and cause some ugly changes to the module, so disable
...
ionic.Platform.ready(function() {
  ...
  // if orientation changes while module is in background, update on resuming
  /*
  if ( ionic.Platform.isWebView() ) {
...
(function () {
    ...
    var Swiper = function (container, params, _scope, $compile) {
        ...
        var defaults = {
            ...
            // To support iOS's swipe-to-go-back gesture (when being used in-module, with UIWebView).
        ...
        s.onTouchStart = function (e) {
            ...
            // Do NOT start if iOS edge swipe is detected. Otherwise iOS module (UIWebView) cannot swipe-to-go-back anymore
