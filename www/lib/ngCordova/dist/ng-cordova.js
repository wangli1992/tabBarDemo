...
angular.module('ngCordova.plugins.healthKit', [])
  ...
  .factory('$cordovaHealthKit', ['$q', '$window', function ($q, $window) {
    ...
    return {
      ...
      /**
       * Check whether or not the user granted your module access to a specific HealthKit type.
...
// install   :      cordova plugin add cordova-plugin-module-preferences
    ...
    return {
      ...
      register: function (config) {
        ...
        if (config !== undefined && config.ecb === undefined) {
          if (document.querySelector('[ng-module]') === null) {
            injector = 'document.body';
          }
          else {
            injector = 'document.querySelector(\'[ng-module]\')';
          }
