 ...
 * in an module build with ngCordova.
 **/
...
ngCordovaMocks.factory('$cordovaDevice', function () {
  ...
  return {
    ...
    /**
     ...
     @description
     The model of the device using the module.
     This property should only be used in automated tests.
     */
    model: model,
 ...
 * in an module built with ngCordova.
 **/
 ...
 * in an module build with ngCordovaMocks.
 */
...
ngCordovaMocks.factory('$cordovaNetwork', ['$rootScope',function ($rootScope) {
  ...
  return {
     ...
     *
     * @description
     * A flag that signals whether the module is connected to a network.
     * This property should only be used in automated tests.
     **/
 ...
 *
 * @description
 * A service for test module screenshot
 * in an module build with ngCordova.
 *
 * @example
 */
