...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    headView.backgroundColor = [self colorWithHexString:@"#f3f4f6"];
...
-(void)cellExternClick:(UIButton *)btn{
    ...
    if([boolArr[btn.tag] isEqualToString:@"0"]){
        ...
        //刷新指定的cell
     // [self.myTableView reloadRowsAtIndexPaths:indexArray withRowAnimation:UITableViewRowAnimationNone];
    }else{
         boolArr[btn.tag] = @"0";
